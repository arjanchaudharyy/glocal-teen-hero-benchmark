...
DATA="""
Aarjan Chaudhary|2026|Applicant|4,5,5,5,5,5,5|high|CVE-2025-51588; research credited by Google, Twitch, EA, Stanford & xAI; published on arXiv with a paper forthcoming at NeurIPS; founder of Arniko Hack Club (Nepal's largest teen tech community, 400+); ran Daydream (250+), Campfire (150+) & the InventionNovelty hacker house; building kroda.ai ($20k+ LOIs); security engineer at Dench (YC S24), also secured Cyber Alert Nepal, AvenueTicket & ShipSec AI; exited ggamechamps (7k+ users), which also won an Emergent Ventures fellowship (the only one from Nepal) from the Mercatus Center at George Mason University|Applicant (2026)|web=https://arjanchaudharyy.lol;x=https://x.com/arjanchaudharyy
